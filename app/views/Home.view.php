            ...
            <div class="w-100 container d-flex flex-row bg-body-light">
                <div class="card bg-dark text-white">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            The Production department has been making significant progress on their work towards
                            upgrading the plant with new production lines.
                            This change is projected to increase product output by 25% and increase yearly revenue by
                            16.7% once completed.
                        </p>
                    </div>
                </div>
